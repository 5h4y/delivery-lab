...
''' 
Generally speaking it's not possible cost-wise for smaller businesses to programmatically implement Twilio's phone number Lookup API. That said, for one-offs or small batches when you need to troubleshoot/explain an SMS delivery problem for a client, I find it can be really helpful. 
